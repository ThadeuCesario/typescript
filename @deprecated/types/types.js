 ...
 */
let hobbies = ['Estudar javascript', 'Cubo Mágico', 'Fazer sudoku', 'Ver vídeos'];
console.log(hobbies);
 ...
 */
let address = ['Avenidade Teste', 123];
console.log(address);
/**
 * Enum
...
let myColor = Colors.Blue; // No caso como é o azul, o retorno é 2
